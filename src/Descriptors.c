 ...
 */
USB_Descriptor_HIDReport_Datatype_t const PROGMEM KeyboardReport[] =
{
...
USB_Descriptor_HIDReport_Datatype_t const ConsumerControlReport[] PROGMEM =
{
...
USB_Descriptor_HIDReport_Datatype_t const DBGReport[] PROGMEM =
{
