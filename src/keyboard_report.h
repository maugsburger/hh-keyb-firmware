...
void    KeyboardReport__init_error(KeyboardReport *this, USB_KeyboardReport_Data_t *dst);
void    KeyboardReport__init_error_copy(KeyboardReport *this, KeyboardReport *dst);
